...
export default function AuthCard({ movies }: Props) {
  ...
  return (
    <div
      ...
      className={`hero flex justify-between items-end pb-4 md:pb-10 px-8 min-h-[15rem] md:h-full text-white col-start-1 row-start-1 md:col-start-2 text-opacity-70`}
    >
