...
export default function MovieCard(props: MovieList) {
  ...
  return (
    <div
      className={`flex flex-col gap-3 items-start rounded-lg  transition-colors ease-in shadow-lg mr-1 pb-4 md:pb-0  md:min-h-[18rem] border border-y-main/50 border-x-accent/50 hover:border-2 hover:shadow-al overflow-x-hidden w-full relative`}
    >
      <Favourite
        movie={moviePayload}
        position="absolute"
      ...
      >
        ...
        <div className={"flex flex-col col-span-2 gap-2 pt-3 px-3"}>
          <h3 className="capitalize font-bold text-lg truncate">
            {name || title}
          </h3>
