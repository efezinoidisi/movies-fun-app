        ...
        {seasons.map((season) => {
          ...
          return (
            <Link
              ...
              prefetch={false}
              key={season.id}
              className="mr-2 rounded-xl pb-3 border-main/20 border hover:border-accent transition-all duration-300 ease-out bg-body group block"
            >
              <MoviePoster
              ...
              <div className="px-2 py-1 flex flex-col gap-2">
                <h4 className=" truncate text-lg font-semibold group-hover:text-blue-600">
                  {season.name}
                </h4>
